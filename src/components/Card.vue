  ...
  <div class="card-container">
    <div class="card">
      <div class="front">
        <div class="cover"></div>
        <div class="user">
          <img class="img-circle" alt="" src="../assets/avatar/default.png" />
        </div>
        <div class="content">
          <div class="main">
...
a.btn-pack {
  ...
  transition-timing-function: cubic-bezier(0.25, 0.8, 0.25, 1),
    cubic-bezier(0.25, 0.8, 0.25, 1), cubic-bezier(0.25, 0.8, 0.25, 1);
